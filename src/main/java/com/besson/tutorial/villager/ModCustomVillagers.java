...
public class ModCustomVillagers {
    ...
    public static final RegistryObject<VillagerProfession> ICE_ETHER_MASTER =
            VILLAGER_PROFESSIONS.register("ice_ether_master", () -> new VillagerProfession("ice_ether_master",
                    x -> x.get() == ICE_ETHER_POI.get(), x -> x.get() == ICE_ETHER_POI.get(),
