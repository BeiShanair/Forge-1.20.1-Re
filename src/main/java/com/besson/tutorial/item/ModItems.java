...
public class ModItems {
    ...
    public static final RegistryObject<Item> ICE_ETHER_PICKAXE = ITEMS.register("ice_ether_pickaxe",
            () -> new PickaxeItem(ModToolTiers.ICE_ETHER, 1, 2, new Item.Properties()));
